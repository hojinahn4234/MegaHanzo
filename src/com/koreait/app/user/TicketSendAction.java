...
public class TicketSendAction implements Action{
	...
	public ActionTo execute(HttpServletRequest req, HttpServletResponse resp) throws Exception {
	    ...
	    params.put("type", "LMS");
	    String tickettext = username+" 고객님 안녕하십니까. "+ticketingdate+"에 등록하신"+movietitle+" 예매내역을 문자로 안내"+
	    		"드립니다. "+starttime+"에 영화가 시작하오니 "+cinemaid+"관에 영화 시작 10분전까지 입장하셔야 한다는 점 유의 바랍니다.";
